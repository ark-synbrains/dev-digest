...
## Corpus Check
- 17 files · ~15,394 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 168 nodes · 280 edges · 13 communities (10 shown, 3 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `449e8c20`
...
Cohesion: 0.14
Nodes (23): archiveIssue(), dateStamp(), DIGESTS_DIR, __dirname, formatDate(), hourStamp(), loadState(), main() (+15 more)
...
## Knowledge Gaps
- **66 isolated node(s):** `name`, `version`, `private`, `type`, `description` (+61 more)
...
- **Should `Run Orchestration` be split into smaller, more focused modules?**
