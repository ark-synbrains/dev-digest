...
- `.graphifyignore` — excludes Cursor/agent **rules**, skills, documentation
  `*.md`, `docs/`, `digests/`, local `agent/out/`, and `package.json` /
  lockfiles from the generated codebase graph (rules and docs are never corpus)
...
.agents/skills/graphify/            /graphify Agent Skill + references
.graphifyignore                     exclude rules/skills/docs/*.md/digests/out/package.json from code graph
